...
namespace GameLogic.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/禁用所有日志", false, 1)]
        ...
        /// 启用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用所有日志", false, 2)]
        ...
        /// 启用调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用调试及以上级别的日志", false, 3)]
        ...
        /// 启用信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用信息及以上级别的日志", false, 4)]
        ...
        /// 启用警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用警告及以上级别的日志", false, 5)]
        ...
        /// 启用错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用错误及以上级别的日志", false, 6)]
        ...
        /// 启用严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用严重错误及以上级别的日志", false, 7)]
        ...
        /// 启用调试日志。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用调试日志", false, 8)]
        ...
        /// 启用信息日志。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用信息日志", false, 9)]
        ...
        /// 启用警告及日志。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用警告日志", false, 10)]
        ...
        /// 启用错误及日志。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用错误及日志", false, 11)]
        ...
        /// 启用严重错误日志。
        /// </summary>
        [MenuItem("工具箱/日志宏定义/启用严重错误日志", false, 12)]
